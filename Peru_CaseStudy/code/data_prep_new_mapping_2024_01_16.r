...
root<- "/Users/edmun/Library/CloudStorage/OneDrive-Personal/Edmundo-ITESM/3.Proyectos/51. WB Decarbonization Project/Peru_CaseStudy/"
file.name <-"peru.csv"
iso_code3 <- "PER"
Country <- "peru"
output.folder <- "/simulations raw/2025_03_10/"
dir.data <- paste0(root,output.folder)
mapping <- read.csv(paste0(root,"code/mapping_corrected_art6.csv"))

#add edgar 
dir.edgar <- "/Users/edmun/Library/CloudStorage/OneDrive-Personal/Edmundo-ITESM/3.Proyectos/51. WB Decarbonization Project/World ensamble/"
edgar <- read.csv(paste0(dir.edgar,"CSC-GHG_emissions-April2024_to_calibrate.csv"))
